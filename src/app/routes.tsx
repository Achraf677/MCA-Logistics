...
function Placeholder({ title }: { title: string }) {
  return (
    <Shell pageTitle={title} actions={['nouveau', 'export']}>
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/livraisons"    element={guard(features.livraisons,   <Placeholder title="Livraisons" />)} />
      ...
      <Route path="/vehicules"     element={guard(features.vehicules,    <Placeholder title="Véhicules" />)} />
      ...
      <Route path="/clients"       element={guard(features.clients,      <Placeholder title="Clients" />)} />
      <Route path="/fournisseurs"  element={guard(features.fournisseurs, <Placeholder title="Fournisseurs" />)} />
      ...
      <Route path="/equipe"        element={guard(features.equipe,       <Placeholder title="Équipe" />)} />
